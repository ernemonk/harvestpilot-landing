    ...
    <section className="pt-24 pb-32 bg-gradient-to-b from-white to-harvest-light/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Left Content - Clear, direct messaging */}
          <div className="animate-slide-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              ...
              <button className="px-8 py-4 border-2 border-gray-300 text-gray-700 rounded-lg hover:border-harvest-green hover:text-harvest-green transition-all font-semibold text-lg">
                See How It Works
              </button>
            </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl p-8 border border-gray-200">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-orange-50 rounded-lg p-4">
                  ...
                  <div className="mt-2 w-full bg-orange-200 h-1.5 rounded-full overflow-hidden">
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-4">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
                  <div className="w-2/3 h-full bg-harvest-green rounded-full transition-all"></div>
                </div>
                <div className="mt-2 text-xs text-gray-600">
                  ✓ Next irrigation: 2h 15m · Est. harvest: Jan 30 (4 days)
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button className="px-4 py-2 bg-harvest-green text-white rounded-lg text-sm font-medium hover:bg-emerald-700 transition-colors">
                  View Details
                </button>
              </div>
            </div>
            ...
            <div className="absolute -top-8 -right-8 w-64 h-64 bg-harvest-green opacity-5 rounded-full blur-3xl -z-10"></div>
            <div className="absolute -bottom-12 -left-12 w-48 h-48 bg-blue-500 opacity-5 rounded-full blur-3xl -z-10"></div>
          </div>
        </div>
        ...
        <div className="mt-20 pt-12 border-t border-gray-200">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 opacity-50">
            <span className="text-2xl font-bold text-gray-400">FARM A</span>
            <span className="text-2xl font-bold text-gray-400">URBAN GREENS</span>
            <span className="text-2xl font-bold text-gray-400">GROW CO</span>
            <span className="text-2xl font-bold text-gray-400">FRESH START</span>
          </div>
        </div>
      </div>
    </section>
