      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Tips, strategies, and insights for growing specialty crops profitably
          </p>
        </div>
          ...
          {featuredPosts.map((post) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-harvest-dark mb-3">
                  {post.title}
                </h3>
        ...
        <div className="text-center">
          <Link 
            to="/blog" 
            className="inline-block px-8 py-3 border-2 border-harvest-green text-harvest-green rounded-lg hover:bg-harvest-light transition font-semibold"
          >
            View All Articles
          </Link>
        </div>
